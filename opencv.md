...
<p align="center">
  <img width=350 height=300 src="https://i.imgur.com/1l8Jy5Z.png">
</p>

- Type `git clone https://github.com/opencv/opencv.git`.

<p align="center">
  <img width=450 height=300 src="https://i.imgur.com/fmBWacp.png">
</p>

- Type `git clone https://github.com/opencv/opencv_contrib.git`.

<p align="center">
  <img width=450 height=300 src="https://i.imgur.com/JCeDERJ.png">
</p>
...
- **Change Version (Optional):**
  ...
  <p align="center">
    <img width=450 height=300 src="https://i.imgur.com/IzPcVdU.png">
  </p>
  ...
  **Note:** Must be same version with above opencv version.
  ...
  <p align="center">
    <img width=450 height=300 src="https://i.imgur.com/OxAcxx8.png">
  </p>
...
<p align="center">
  <img width=470 height=500 src="https://i.imgur.com/4I3aZJb.png">
</p>
...
<p align="center">
  <img width=470 height=500 src="https://i.imgur.com/ei3lu5o.png">
</p>

- Close Cmake then go to **build** folder and open the `OpenCV.sln`.
-	Choose `Debug` tor `Release` mode with `x64`.
